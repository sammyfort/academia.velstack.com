                ...
                @forelse($logs as $log)
                    ...
                    <div class="acitivity-item py-3 d-flex">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="mb-1">{{str_replace('_', '', class_basename($log->subject_type))." $log->event by {$log->causer->fullname}"}}

                                <span class="subtle text-success align-middle ms-1">{{$log->causer->school?->name}}</span>
                            </h6>
