<div>
    @section("title", 'Incoming Transfers')
    <div class="row">
        <div class="col-lg-12">
            <div class="card" id="customerList">
                <div class="card-header border-bottom-dashed">
                    ...
                    <div class="row g-4 align-items-center">
                        <div class="col-sm">
                            <div>
                                <h5 class="card-title mb-0">Incoming Transfers</h5>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div>
                        <div class="table-responsive table-card mb-1">
                            <table class="table table-nowrap align-middle">
                                ...
                                <tr class="text-uppercase">
                                    ...
                                    <th class="sort" data-sort="customer_name">Transferred From</th>
                                        ...
                                        <td>
                                            <ul class="list-inline hstack gap-2 mb-0">
                                                <li class="list-inline-item" title="Are you sure ?">
                                                    <a href="{{route('transfers.incoming.update', $transfer->uuid)}}" class="btn btn-success btn-sm">
                                                        View Transfer
                                                    </a>
                                                </li>
                                            </ul>
                        ...
                        <x-paginate :collection="$incomingTransfers"/>
