...
@section("title", "Class Timetable - $class->name")
...
@section('content')
    ...
    <div class="page-container">
        <div class="content-wrapper">
            <h2 class="text-center mb-4">{{$class->school->name}}</h2>
            <h6 class="text-center mb-4">Class Timetable - {{ $class->name }}</h6>
                    ...
                    @foreach ($days as $day)
                        <tr>
                            ...
                            @foreach ($timeSlots as $slot)
                                <td>
                                    @php
                                        $entry = $timetables->where('class_id', $class->id)
                                                           ->where('day', $day)
