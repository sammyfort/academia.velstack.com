                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div class="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <Button v-if="search || props.subjects.current_page > 1 || date"
                    ...
                    <div class="w-full sm:w-auto mt-4 sm:mt-0">
                        <SubjectCreate :available_subjects="available_subjects"
                                       @created="$inertia.reload({ only: ['subjects'] })">
                            <Button
                        ...
                        <TableRow v-for="subject in props.subjects.data as SubjectI[]" :key="subject.id">
                            ...
                            <TableCell>
                                <div class="flex gap-2">
                                    <SubjectEdit :subject="subject" :available_subjects="available_subjects"
