...
<template>
  ...
  <GuestLayout>
    <!-- form slot content: make sure this wrapper has no external vertical padding -->
    <div class="flex items-center justify-center bg-white min-h-[600px] lg:min-h-[700px]">
      <div class="px-8 py-8 lg:px-16 lg:py-12 w-full max-w-lg">
        <form @submit.prevent="login" class="space-y-6">
          ...
          <Button
            type="submit"
            class="w-full h-12 text-base font-semibold bg-secondary hover:bg-secondary/90"
          ...
          <Button
            variant="outline"
            type="button"
            class="w-full h-12 border-2 hover:bg-gray-50"
