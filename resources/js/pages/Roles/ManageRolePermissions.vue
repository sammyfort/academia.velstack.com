            ...
            <div v-else
                ...
                <div class="p-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="flex flex-col sm:flex-row gap-2 sm:justify-end">
                        <Button size="sm" variant="outline" @click="selectAll">Select All ({{ permissions.length }})</Button>
                        <Button size="sm" variant="destructive" @click="unselectAll">Unselect All ({{ form.permissions.length }})</Button>
                    </div>
                </div>
