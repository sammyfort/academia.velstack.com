...
import {InputSelectOption, StaffI} from "@/types";
...
const form = useForm({
    ...
    national_id: props.staff.national_id,

    gender: props.staff.gender,
    bio: props.staff.bio,
    dob: props.staff.dob,
    religion: props.staff.religion,
    region: props.staff.region,
    city: props.staff.city,

    marital_status: props.staff.marital_status,
    licence_no: props.staff.licence_no,
    qualification: props.staff.qualification,
    experience: props.staff.experience,
...
const updateStaff = () => {
    form.transform((data) => ({
        ...data,
        _method: 'PUT'
    })).post(route("staff.update", props.staff.id), {
        onSuccess: (res) => {
        ...
        <div class="max-w-full mx-auto px-1 sm:px-6 lg:px-8 py-8">
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-4 lg:gap-8">
                ...
                <div class="order-2 lg:order-1 lg:col-span-3 space-y-6">
                    <form @submit.prevent="updateStaff" id="add-staff" class="p-2 sm:p-8">
                        <div class="mb-8">
                        ...
                        <div class="bg-background rounded-xl shadow-sm border border-gray-200 p-6">
                            ...
                            transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    ...
                                    {{ form.processing ? 'Please wait' : 'Update Staff' }}
                                </Button>
                            </div>
                        </div>
                    </form>
