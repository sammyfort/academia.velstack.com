            ...
            <div class="max-w-12xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h1 class="text-xl font-bold text-foreground">Update Student</h1>
                            <p class="text-sm text-muted-foreground">Update student records</p>
                        </div>
                    </div>
                    <Link
        ...
        <div class="min-h-screen bg-background py-8">
            <div class="max-w-7xl mx-auto px-6">
                ...
                <div class="bg-background rounded-2xl shadow-xl overflow-hidden">
                    <form @submit.prevent="updateStudent" id="edit-student" class="p-8">
                        <div class="mb-8">
                        ...
                        <div class="pt-6 border-t border-gray-200">
                            <div class="flex flex-col sm:flex-row gap-4 justify-end">
                                ...
                                <Button :disabled="form.processing" type="submit" form="edit-student">
                                    <LoaderCircle
